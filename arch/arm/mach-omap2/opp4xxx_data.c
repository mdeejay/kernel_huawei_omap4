...
#define OMAP4460_VDD_MPU_OPPNITRO_UV		1360000
#define OMAP4460_VDD_MPU_OPPNITROSB_UV		1375000
#define OMAP4460_VDD_MPU_OPPNITROSB_UV_OC	1380000
//#define OMAP4460_VDD_MPU_OPPNITROSB_UV_OCP	1390000
...
//	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROSB_UV_OCP, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
#define OMAP4460_VDD_CORE_OPP100_OV_UV		1270000
...
//	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITROSB_UV_OCP, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1500000000, OMAP4460_VDD_MPU_OPPNITROSB_UV),
        /* MPU OPP4 - OPP-OC SpeedBin */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1600000000, OMAP4460_VDD_MPU_OPPNITROSB_UV_OC),
//	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1700000000, OMAP4460_VDD_MPU_OPPNITROSB_UV_OCP),
